...
<html lang="en">
 ...
 <body style="background-image: url(back15.jpg);">
  ...
  <br>
      ...
      <div class="container-fluid">
            ...
            <div class="row intro py-1">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img class="im" src="bank3.jpg" class="img-fluid pt-2">
              </div>
            </div>
         </div>
          ...
          <br>
          <br>
          <h3 class="action" ><span style="font-family: 'Roboto Slab', serif">CHOOSE ACTION</h3></span>
      ...
      <footer class="text-center mt-5 py-2">
        <p>Project by <b>Suvarna Pawar</b> <br> </p>
      </footer>
